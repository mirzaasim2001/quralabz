      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <div className="flex-1 flex flex-col lg:flex-row min-h-0 overflow-hidden">
          ...
          <div className="lg:w-1/2 flex flex-col min-h-0 border-b lg:border-b-0 lg:border-r border-white/8">
            ...
            {/* ═══════════════════════════════════════════════════════
                ADSENSE PLACEMENT: Lesson Content In-Article
                Size: 300×250 or responsive
                Position: Scrolls with content in the reading pane.
                Note: Placed BELOW the fold — user reads first.
            ═══════════════════════════════════════════════════════ */}
